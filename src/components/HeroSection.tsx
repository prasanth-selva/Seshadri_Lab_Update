    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-500 leading-tight mb-2 tracking-tight">
              Seshadri Lab
            </h1>
            <p className="text-gold-gradient text-lg md:text-xl lg:text-2xl font-medium tracking-wide mb-8 uppercase letter-spacing-widest">
              Lehigh University
            </p>
          </motion.div>
          ...
          <motion.p 
            ...
            className="text-neutral-300 max-w-xl text-base md:text-lg leading-relaxed font-light mb-10"
          >
